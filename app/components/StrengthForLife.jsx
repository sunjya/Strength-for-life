...
const Icons = {
  ...
  settings: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-full h-full">
      ...
      <path d="M10.3 4.7a1.8 1.8 0 0 1 3.4 0l.4 1.2a1 1 0 0 0 1.5.5l1.1-.7a1.8 1.8 0 0 1 2.4 2.4l-.7 1.1a1 1 0 0 0 .5 1.5l1.2.4a1.8 1.8 0 0 1 0 3.4l-1.2.4a1 1 0 0 0-.5 1.5l.7 1.1a1.8 1.8 0 0 1-2.4 2.4l-1.1-.7a1 1 0 0 0-1.5.5l-.4 1.2a1.8 1.8 0 0 1-3.4 0l-.4-1.2a1 1 0 0 0-1.5-.5l-1.1.7a1.8 1.8 0 0 1-2.4-2.4l.7-1.1a1 1 0 0 0-.5-1.5l-1.2-.4a1.8 1.8 0 0 1 0-3.4l1.2-.4a1 1 0 0 0 .5-1.5l-.7-1.1a1.8 1.8 0 0 1 2.4-2.4l1.1.7a1 1 0 0 0 1.5-.5l.4-1.2z"/>
    </svg>
  ),
  plus: () => (
